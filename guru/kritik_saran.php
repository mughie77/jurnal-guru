...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_kritik'])) {
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        if (empty($subjek) || empty($isi)) {
            ...
            $stmt = mysqli_prepare($conn, "INSERT INTO kritik_saran (user_id, nama_pengirim, role, subjek, isi) VALUES (?, ?, 'guru', ?, ?)");
            mysqli_stmt_bind_param($stmt, "isss", $guru_id, $nama_guru, $subjek, $isi);
...
// Retrieve past submissions for current teacher
$query = "SELECT * FROM kritik_saran WHERE user_id = ? AND role = 'guru' ORDER BY tanggal DESC";
    ...
    <div class="p-4 lg:p-8 max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-slate-400 font-bold text-[10px] uppercase tracking-widest mt-1">Kirim Umpan Balik / Usulan Guru</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="lux-card p-6 bg-white border-none shadow-xl">
                    <h3 class="font-black text-slate-800 italic uppercase tracking-widest text-xs mb-6">Form Usulan Guru</h3>
                    <form action="" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="subjek" required placeholder="Contoh: Kurikulum, Alat Mengajar, dll..."
                        ...
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Kritik / Saran / Usulan</label>
                            <textarea name="isi" rows="5" required placeholder="Tulis kritik, saran, atau usulan mengajar Anda..."
